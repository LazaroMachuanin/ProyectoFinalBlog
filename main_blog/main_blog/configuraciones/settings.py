...
INSTALLED_APPS = [
    ...
    #abajo vamos declarando las nuevas aplicaciones
    'apps.posts',
    'apps.contacto',
    'apps.usuario',
]
...
DATABASES = {
    'default': {
        ...
        'USER': 'root',
        'PASSWORD': '1111',
        'HOST': 'localhost',  # Puedes cambiar esto si tu MySQL está en otro servidor
        'PORT': '3306',           # Si usas un puerto específico, puedes definirlo aquí
    }
}
